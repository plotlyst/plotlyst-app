...
people = [
    ...
    "mdi.account-heart", "mdi.account-key", "mdi.account-hard-hat", "mdi6.account-school",
    "mdi6.account-school-outline",
    "mdi.account-multiple", "mdi.account-reactivate",
...
nature = [
    'msc.globe', 'fa5s.globe', 'mdi.globe-model', 'ei.globe',
    'mdi.nature', 'mdi.nature-people', "fa5.lemon", "fa5.snowflake", "fa5.sun", 'mdi.flower',
    'mdi.flower-outline', 'mdi.image-filter-vintage', 'mdi.image-filter-hdr', 'mdi.island', 'mdi.mushroom',
    'mdi.mushroom-outline', 'mdi.flower-poppy', 'mdi.flower-tulip', 'mdi.flower-tulip-outline', "ph.flower",
    "ph.flower-fill", "ph.flower-lotus", "ph.flower-lotus-bold", "ph.flower-lotus-fill", "mdi6.flower-pollen",
    "fa5s.apple-alt",
    ...
    'mdi.spider-web', "fa5s.tree", "mdi.tree", 'mdi.leaf-maple', 'mdi.cannabis', "fa5s.wind", 'mdi.campfire',
    "fa5s.mountain",
    ...
    "fa5s.cloud-showers-heavy", "fa5s.cloud-sun", "fa5s.cloud-sun-rain", "fa5s.meteor", "fa5.moon", "fa5s.moon",
    "mdi.moon-full", "mdi.moon-waning-crescent", "mdi.moon-last-quarter", "mdi.moon-waning-gibbous",
    "mdi.moon-waxing-gibbous", "mdi6.moon-first-quarter", "mdi.moon-waxing-crescent", "mdi.moon-new",
    "ph.cloud-moon-fill", "ph.moon-stars", "ph.moon-stars-fill", "ri.moon-cloudy-fill", "ri.moon-cloudy-line",
    "fa5s.poo-storm",
    "fa5s.rainbow", "fa5s.smog", "fa5s.snowflake", "fa5s.sun", "fa5s.icicles", "fa5s.meteor",
    "fa5s.pastafarianism", "mdi.barley", "mdi.bee", "mdi.bee-flower", "mdi.beehive-outline", "mdi.brightness-3", "", "",
    "mdi.cactus", "mdi.carrot", "mdi.hydro-power", "mdi.palm-tree", "mdi.pine-tree", "ph.tree", "ph.tree-fill",
    "mdi.unicorn",
    "mdi.unicorn-variant", "", "", "",
...
objects = [
    'mdi.sword', 'mdi.sword-cross', 'ph.sword', 'mdi6.shield-sword', 'mdi6.shield-sword-outline', 'mdi6.spear',
    'fa5s.crown',
    ...
    'mdi.necklace', 'mdi.purse', "fa5s.glasses", "mdi.glasses", "mdi.sunglasses",
    ...
    "fa5.envelope",
    "fa5.envelope-open", 'mdi.box-cutter', 'mdi.gift-open-outline', 'mdi.gift-outline', 'mdi.gift', 'mdi6.teddy-bear',
    ...
    'mdi.pistol', 'mdi.knife', 'mdi.knife-military', 'ph.knife', 'ph.knife-bold', 'ri.knife-blood-fill',
    'ri.knife-blood-line', 'mdi.saw-blade', "fa5s.bomb",
    "fa5s.bone", "fa5s.bong",
    ...
    "fa5s.brush", "fa5s.drafting-compass", "fa5s.dumpster", 'mdi.bullhorn', "fa5s.paint-roller",
    ...
    'mdi.spade', "fa5s.hamburger", "fa5s.hanukiah", "fa5s.hard-hat", "fa5b.redhat", "fa5s.hat-cowboy",
    "fa5s.hat-cowboy-side", "mdi.chef-hat", "mdi.hat-fedora",
    "fa5s.hat-wizard", 'mdi.wizard-hat', "mdi.school", "mdi.school-outline",
...
symbols = [
    ...
    'mdi.chat', 'mdi.chat-alert', 'mdi.chat-alert-outline', 'mdi.chat-outline', 'mdi.chat-question-outline',
    'mdi.chat-sleep', 'mdi.chat-sleep-outline', 'ph.chat-circle-dots', 'ph.chat-centered-text', 'ph.chat-circle-light',
    'ph.chats-circle', 'ri.chat-heart-fill', 'ri.chat-heart-line',

    'mdi.music', 'mdi.music-clef-treble', 'mdi.music-note', 'mdi.music-note-half',
    "mdi.account-music",
